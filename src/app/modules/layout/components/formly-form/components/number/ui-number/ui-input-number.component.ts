...
export const INPUTNUMBER_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => UIInputNumber),
  multi: true,
};
@Component({
...
export class UIInputNumber implements OnInit, ControlValueAccessor {
  ...
  @Output() readonly onInput: EventEmitter<any> = new EventEmitter();
        ...
        if (selectionStart === selectionEnd) {
          ...
          if (this.isNumeralChar(deleteChar)) {
            ...
            if (this._group.test(deleteChar)) {
              ...
              newValueStr = inputValue.slice(0, selectionStart - 1) + insertedText + inputValue.slice(selectionStart) ?? null;
            } else if (decimalCharIndexWithoutPrefix === 1) {
              newValueStr = inputValue.slice(0, selectionStart - 1) + '0' + inputValue.slice(selectionStart) ?? null;
